...
<!-- version: 1.1.0 -->
<!-- guid: f2a3b4c5-d6e7-8901-f789-012345678901 -->
...
- All changes to Rust release logic should be made in the embedded Python script within action.yml.
...
This repository provides a composite GitHub Action that builds and releases Rust applications.
