...
- This is a composite GitHub Action that embeds Python logic directly in
  action.yml.
- All changes to Rust release logic should be made in the embedded Python script
  within action.yml.
...
This repository provides a composite GitHub Action that builds and releases Rust
applications.
